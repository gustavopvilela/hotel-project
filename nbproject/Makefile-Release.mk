...
${OBJECTDIR}/exportacao/exportacao.o: exportacao/exportacao.c
	...
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/exportacao/exportacao.o exportacao/exportacao.c
...
${OBJECTDIR}/gestao_dados/acomodacao/acomodacao.o: gestao_dados/acomodacao/acomodacao.c
	...
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/gestao_dados/acomodacao/acomodacao.o gestao_dados/acomodacao/acomodacao.c
...
${OBJECTDIR}/gestao_dados/categoria_acomodacao/categoria_acomodacao.o: gestao_dados/categoria_acomodacao/categoria_acomodacao.c
	...
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/gestao_dados/categoria_acomodacao/categoria_acomodacao.o gestao_dados/categoria_acomodacao/categoria_acomodacao.c
...
${OBJECTDIR}/gestao_dados/controle_arquivos/controle_arquivos.o: gestao_dados/controle_arquivos/controle_arquivos.c
	...
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/gestao_dados/controle_arquivos/controle_arquivos.o gestao_dados/controle_arquivos/controle_arquivos.c
...
${OBJECTDIR}/gestao_dados/fornecedor/fornecedor.o: gestao_dados/fornecedor/fornecedor.c
	...
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/gestao_dados/fornecedor/fornecedor.o gestao_dados/fornecedor/fornecedor.c

${OBJECTDIR}/gestao_dados/hospede/hospede.o: gestao_dados/hospede/hospede.c
	${MKDIR} -p ${OBJECTDIR}/gestao_dados/hospede
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/gestao_dados/hospede/hospede.o gestao_dados/hospede/hospede.c

${OBJECTDIR}/gestao_dados/hotel/hotel.o: gestao_dados/hotel/hotel.c
	${MKDIR} -p ${OBJECTDIR}/gestao_dados/hotel
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/gestao_dados/hotel/hotel.o gestao_dados/hotel/hotel.c

${OBJECTDIR}/gestao_dados/operador/operador.o: gestao_dados/operador/operador.c
	${MKDIR} -p ${OBJECTDIR}/gestao_dados/operador
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/gestao_dados/operador/operador.o gestao_dados/operador/operador.c
...
${OBJECTDIR}/relatorio/acomodacoes/listagemAcomodacao.o: relatorio/acomodacoes/listagemAcomodacao.c
	...
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/relatorio/acomodacoes/listagemAcomodacao.o relatorio/acomodacoes/listagemAcomodacao.c
...
${OBJECTDIR}/relatorio/reservas/listagemReserva.o: relatorio/reservas/listagemReserva.c
	...
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/relatorio/reservas/listagemReserva.o relatorio/reservas/listagemReserva.c
