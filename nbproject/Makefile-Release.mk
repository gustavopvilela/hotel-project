...
${OBJECTDIR}/transacoes/checkin/checkin.o: transacoes/checkin/checkin.c
	...
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/transacoes/checkin/checkin.o transacoes/checkin/checkin.c
...
${OBJECTDIR}/transacoes/entrada_produtos/entrada_produtos.o: transacoes/entrada_produtos/entrada_produtos.c
	...
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/transacoes/entrada_produtos/entrada_produtos.o transacoes/entrada_produtos/entrada_produtos.c

${OBJECTDIR}/transacoes/venda/vendas.o: transacoes/venda/vendas.c
	${MKDIR} -p ${OBJECTDIR}/transacoes/venda
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/transacoes/venda/vendas.o transacoes/venda/vendas.c
